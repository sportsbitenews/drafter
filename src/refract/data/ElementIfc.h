...
#ifndef REFRACT_EXPERIMENTAL_ELEMENTIFC_H
#define REFRACT_EXPERIMENTAL_ELEMENTIFC_H
...
namespace refract
{
    namespace experimental
    {
        ...
        struct IElement {
            ...
            ///
            virtual NamedElements& meta() noexcept = 0;
            //
            ///
            /// Query the meta of this Element
            ///
            /// @return named Elements representing meta information
            ///
            virtual const NamedElements& meta() const noexcept = 0;
            ...
            ///
            virtual NamedElements& attributes() noexcept = 0;
            ...
            /// @return named Elements representing attributes
            ///
            virtual const NamedElements& attributes() const noexcept = 0;
